         ...
         <div class="container-fluid">   
            ...
            <div class="card shadow mb-4">
               <div class="card-header py-3">
                  <h4 class="m-0 ">공지사항 작성</h4>
               </div>
         
               <div class="card-body">
                  <form name="noticeForm" id="noticeForm" action="${pageContext.request.contextPath}/notice/create" method="POST">
                     ...
                     </select><p>제목</p> <input type="text" id="notice_title" name="notice_title" placeholder="공지사항 제목"><br>
                  <p>내용</p>   <textarea rows="10" cols="100" id="notice_content" name="notice_content" placeholder="공지사항 내용"></textarea>
                     <br>
                     <button name="create_notice" id="create_notice">공지사항 작성</button>
                  </form>
               </div>
            </div>
         </div>
