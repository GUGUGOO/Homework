				...
				<div class="card shadow mb-4">
					...
					<div class="card-body">
						...
						<form class="form-group col-md-8" id="updateUser" method="post" enctype="multipart/form-data">
							...
							<div id="select_img"><img src="${user.getEnroll_image() }" style="width:150px;height:200px" /></div> <br/>
					        <!-- 이름 -->
					        <strong><label for="Enroll_name">이름: </label></strong>
					        <input class="form-control" type="text" id="Enroll_name" name="Enroll_name" value='${user.getEnroll_name()}'><br/>			
					        <!-- ID -->
					    
						      	<strong><label for="Enroll_id">ID: </label></strong>
						    	<p class="form-control bg-secondary text-white">${user.getEnroll_id() }</p>
						    	<input class="form-control" type="text" id="Enroll_id" name="Enroll_id" value='${user.getEnroll_id()}' hidden="hidden">
					    	...
					    	<!-- 생년월일 -->
					    		...
					    		<p class="form-control bg-secondary text-white">${user.getEnroll_birth() }</p>
					    		<input class="form-control" type="text" id="Enroll_birth" name="Enroll_birth" value='${user.getEnroll_birth()}' hidden="hidde"><br/>
					    	<!-- 핸드폰 번호 -->
					    		<strong><label for="Enroll_phone">핸드폰 번호: </label></strong>
					    		<input class="form-control" type="text" id="Enroll_phone" name="Enroll_phone" value='${user.getEnroll_phone()}'><br/>
					    	<!-- 이메일 -->
						    	<strong><label for="Enroll_mail">이메일: </label></strong>
					    		<input class="form-control" type="text" id="Enroll_mail" name="Enroll_mail" value='${user.getEnroll_mail()}'><br/>
					    	<!-- 부서 부서관리자는 건들 수 없음 -->
						...
						<c:if test="${user.getEnroll_category() != '03'}">
			       		<div class="form-row float-right">
				   			<button class="btn btn-dark btn-space" id="submitUser">수정</button>
