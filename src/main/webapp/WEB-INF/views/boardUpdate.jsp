            ...
            <div class="card shadow mb-4">
               ...
               <div class="card-body">
                  <div class="table-responsive">
                     <form name="boardForm" id="boardForm" action="${pageContext.request.contextPath}/board/update" method="POST">
                        <input type="hidden" name="Board_idx" value="${boardVO.board_idx}"><p>제목</p> <input type="text" id="Board_title" name="Board_title" placeholder="${boardVO.board_title}" value="${boardVO.board_title}"> <br>
                        <p>내용</p><textarea rows="10" cols="100" id="Board_content" name="Board_content" placeholder="${boardVO.board_content}"></textarea>
                        <br>
                        <button name="create_board" id="create_board">게시글 수정</button>
                     </form>
