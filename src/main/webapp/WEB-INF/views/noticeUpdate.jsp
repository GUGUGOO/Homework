            ...
            <div class="card shadow mb-4">
               ...
               <div class="card-body">
                  <div class="table-responsive">
                     <form name="noticeForm" id="noticeForm" action="${pageContext.request.contextPath}/notice/update" method="POST">
                        <input type="hidden" name="Notice_idx" value="${noticeVO.notice_idx}"> 
                        <p>제목</p><input type="text" id="Notice_title" name="Notice_title" placeholder="${noticeVO.notice_title}" value="${noticeVO.notice_title}"> <br>
                        <p>내용</p><textarea rows="10" cols="100" id="Notice_content" name="Notice_content" placeholder="${noticeVO.notice_content}"></textarea>
                        <br>
                        <button name="create_notice" id="create_notice">공지사항 수정</button>
                     </form>
