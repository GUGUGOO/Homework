                  ...
                  <div align="right">
                           ...
                           <tbody>
                              <c:forEach items="${boardVOList}" var="board">
                                 <tr>
                                    ...
                                    <td><a
                                       href="${pageContext.request.contextPath}/board/read?boardIdx=${board.board_idx}">${board.board_title   }</a>
                                    </td>
                                 ...
                                 <ul class='pagination' id='pageMove'>
                                    ...
                                    <c:forEach begin="${pageMaker.startPage}"
                                       ...
                                       <li class="paginate_button page-item"
                                          ...
                                          href="${pageContext.request.contextPath}/board/list?page=${idx}&keyWord=${keyWord}">${idx}</a></li>
                                    </c:forEach>
                     ...
                     <div class="btn_right mt15">
                        <button type="button" class="btn black mr5"
                           onclick="create_board()">게시글 작성</button>
                     </div>
                  </div>
               </div>
            </div>
